...
def apply_config_defaults(config: dict) -> dict:
    ...
    gcal.setdefault('redirect_base_url', '')
    gcal.setdefault('default_sync_mode', 'import_only')
    gcal.setdefault('allow_bidirectional_opt_in', True)
    gcal_import = gcal.setdefault('import', {})
    gcal_import.setdefault('require_mapping_review', True)
